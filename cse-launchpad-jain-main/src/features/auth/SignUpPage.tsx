            ...
            <Card className="relative z-10 w-full max-w-md border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl transition-all duration-500 hover:scale-[1.005] hover:shadow-indigo-500/10 animate-in fade-in slide-in-from-bottom-8">
                ...
                <CardContent>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        {/* 🔘 Role Selection */}
                        <div className="grid grid-cols-2 gap-4 p-1 rounded-xl bg-slate-900/50 border border-white/5 mb-6">
                            <div
                        ...
                        <div className="space-y-2 group">
                            <Label htmlFor="name" className="text-slate-300 text-xs font-medium uppercase tracking-wider ml-1">Full Name</Label>
                            ...
                            {form.formState.errors.name && (
                                <p className="text-xs text-red-400 ml-1 animate-in slide-in-from-top-1">{form.formState.errors.name.message}</p>
                            )}
                        </div>
                        ...
                        <div className="space-y-2 group">
                            <Label htmlFor="password" className="text-slate-300 text-xs font-medium uppercase tracking-wider ml-1">Password</Label>
                            <div className="relative transition-transform duration-200 focus-within:scale-[1.01]">
                                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 transition-colors group-focus-within:text-indigo-400">
                        ...
                        <div className="space-y-2 group">
                            <Label htmlFor="confirmPassword" className="text-slate-300 text-xs font-medium uppercase tracking-wider ml-1">Confirm Password</Label>
                            <div className="relative transition-transform duration-200 focus-within:scale-[1.01]">
                                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 transition-colors group-focus-within:text-indigo-400">
                                    <Lock className="h-4 w-4" />
                                </div>
                            ...
                            {form.formState.errors.confirmPassword && (
                                <p className="text-xs text-red-400 ml-1 animate-in slide-in-from-top-1">{form.formState.errors.confirmPassword.message}</p>
                            )}
                        </div>
                        ...
                        <Button
                            type="submit"
                            className="w-full h-11 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-medium shadow-lg shadow-indigo-500/25 transition-all duration-300 hover:scale-[1.01] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed mt-4"
                            disabled={isPending}
                        >
                ...
                <CardFooter className="flex justify-center border-t border-white/5 pt-6 pb-6">
                    <p className="text-sm text-slate-500">
                        ...
                        <Link to="/" className="text-indigo-400 hover:text-indigo-300 font-medium hover:underline underline-offset-4 transition-colors">
                            Sign in
                        </Link>
                    </p>
                </CardFooter>
